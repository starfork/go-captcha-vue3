<template>
  <div class="wg-cap-btn" :style="style">
    <div class="wg-cap-btn__inner" :class="activeClass">
      <el-popover :visible="popoverVisible" placement="top" trigger="click" width="360">
        <Captcha width="300px" height="240px" :max-dot="maxDot" :image-base64="imageBase64" :thumb-base64="thumbBase64"
          @close="handleCloseEvent" @refresh="handleRefreshEvent" @confirm="handleConfirmEvent" />
        <template #reference>
          <div>
